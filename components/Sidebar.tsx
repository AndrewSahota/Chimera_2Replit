...
export default function Sidebar({ activePage, onNavigate, botStore }: SidebarProps) {
  ...
  const [expandedSections, setExpandedSections] = useState<Set<string>>(new Set(['Core', 'Research', 'Execution']));
  ...
  const { bots, selectedBot, currentBotStatus, actions } = botStore;
